    ...
    public class Engineering_Services_Applications_Repository :BaseRepository<Engineering_Services_Applications>
    {
        public IList<Engineering_Services_Applications> ListEngineeringServicesApplications(int? Engineering_Services_Applications_Id, int? Engineering_Services_Id)
        {
            ...
            try
            {
                ...
                DbCommand sqlCommand = _db.GetStoredProcCommand("sp_List_Engineering_Services_Applications");
                DataSet dataSet = new DataSet();

                var P1 = sqlCommand.CreateParameter();
                P1.ParameterName = "Engineering_Services_Applications_Id";
                P1.Value = Engineering_Services_Applications_Id;
                ...
                {
                    List_Obj = DataBaseUtil.DataTableToList<Engineering_Services_Applications>(ds.Tables[0]);
                }
            }
            catch (Exception  ex)
            {
