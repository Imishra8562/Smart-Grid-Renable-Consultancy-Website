...
namespace DataLayer
{
    public class EngineeringServicesRepository : BaseRepository<Engineering_Services>
    {
        
        public IList<Engineering_Services> ListEngineeringServices(int? Engineering_Services_Id = null, string Url_Link = null)
        {
            IList<Engineering_Services> list = null;
            ...
            try
            {
                ...
                {
                    list = DataBaseUtil.DataTableToList<Engineering_Services>(ds.Tables[0]);
                }
            }
            catch (Exception ex)
            {
        ...
        // ----------------------------
        private IList<Engineering_Services_SubTopic> ListSubTopics(int serviceId)
        {
            IList<Engineering_Services_SubTopic> list = null;
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.Create("DefConn");
                ...
                {
                    list = DataBaseUtil.DataTableToList<Engineering_Services_SubTopic>(ds.Tables[0]);
                }
            }
            catch { }
        ...
        private IList<Engineering_Services_Feature> ListFeatures(int serviceId)
        {
            IList<Engineering_Services_Feature> list = null;
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.Create("DefConn");
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    list = DataBaseUtil.DataTableToList<Engineering_Services_Feature>(ds.Tables[0]);
                }
            }
            catch { }
        ...
        private IList<Engineering_Services_Application> ListApplications(int serviceId)
        {
            IList<Engineering_Services_Application> list = null;
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.Create("DefConn");
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    list = DataBaseUtil.DataTableToList<Engineering_Services_Application>(ds.Tables[0]);
                }
            }
            catch { }
        ...
        private IList<Engineering_Services_GalleryImage> ListGalleryImages(int serviceId)
        {
            IList<Engineering_Services_GalleryImage> list = null;
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                Database db = factory.Create("DefConn");
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    list = DataBaseUtil.DataTableToList<Engineering_Services_GalleryImage>(ds.Tables[0]);
                }
            }
            catch { }
        ...
        private IList<Engineering_Services_Tab> ListTabs(int serviceId)
        {
            IList<Engineering_Services_Tab> list = null;
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                list = DataBaseUtil.DataTableToList<Engineering_Services_Tab>(ds.Tables[0]);
            }
