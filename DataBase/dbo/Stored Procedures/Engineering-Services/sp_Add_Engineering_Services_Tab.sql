...
BEGIN
BEGIN TRY  
   DECLARE @Engineering_Services_TabId INT
   SELECT @Engineering_Services_TabId=Engineering_Services_Tab_Id from tbl_Engineering_Services_Tab where Engineering_Services_Tab_Title=@Engineering_Services_Tab_Title AND Is_Active=1
		
   IF @Engineering_Services_TabId IS NULL
	  BEGIN
...
BEGIN CATCH    
   ...
   SELECT @ErrorMessage ='SP ERROR : ADD Engineering Services Tab FAILED' + Char(13) + Char(10) + 'THE ERROR WAS : ' + Char(13) + Char(10) + ERROR_MESSAGE()   
