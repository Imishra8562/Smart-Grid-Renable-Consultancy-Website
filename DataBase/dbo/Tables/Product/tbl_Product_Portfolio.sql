CREATE TABLE [dbo].[tbl_Product_Portfolio]
(
[Product_Portfolio_Id] INT IDENTITY (1,1) NOT NULL,
...
CONSTRAINT[PK_tbl_Product_Portfolio] PRIMARY KEY CLUSTERED ([Product_Portfolio_Id] ASC) 
