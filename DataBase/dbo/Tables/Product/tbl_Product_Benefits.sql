CREATE TABLE [dbo].[tbl_Product_Benefits]
(
[Product_Benefits_Id] INT IDENTITY (1,1) NOT NULL,
...
CONSTRAINT[PK_tbl_Product_Benefits] PRIMARY KEY CLUSTERED ([Product_Benefits_Id] ASC) 
