CREATE TABLE [dbo].[tbl_Knowledge_Card]
(
    [Knowledge_Card_Id] INT IDENTITY(1,1) NOT NULL,
   ...
   CONSTRAINT [Pk_Knowledge_Card] PRIMARY KEY CLUSTERED ([Knowledge_Card_Id] ASC)
